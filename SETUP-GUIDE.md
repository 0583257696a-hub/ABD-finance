...
| יכולת | מה נדרש |
|---|---|
| WhatsApp אוטומטי (שליחה מהשרת, תזכורות) | חשבון WhatsApp Business API (Meta) — אימות עסק, מספר ייעודי, תבניות מאושרות. **היום כבר קיים:** בארכיון הסיכומים כפתור "וואטסאפ" פותח את WhatsApp במכשיר של היועץ עם תמצית הסיכום מוכנה (המלצות + המשך טיפול + הסתייגות) — בוחרים איש קשר ושולחים. ללא הגדרה. "שלח ללקוח" שולח את המסמך המלא במייל |
